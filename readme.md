...
|-|正面|背面|
|---|---|---|
|MCU本體電路板|![pcb1](pics/mainpcb1.png)|![pcb1](pics/mainpcb2.png)|
|TRRS、EC-11的專用電路板|![pcb1](pics/otherpcb1.png)|![pcb1](pics/otherpcb2.png)|

### 螺絲零件

|名稱|數量|備註|
|---|---|---|
|微型控制器|2|`ProMicro`系列或`RP2040-zero`系列|
